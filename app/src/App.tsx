...
import {
    ...
    Container,
    Jumbotron, Nav, NavItem, NavLink, Row
} from "reactstrap";
import './App.css';
...
console.log(LOREM_JIBBERISH)

const App: React.FC = () => {
    return (
        <>
            <Container fluid="true">
                <Jumbotron className="mb-0 border-0">
                    <h1 className="display-4">lahiyam</h1>
                    <p className="lead display-3">Nonsensical whisperings</p>
                    <hr className="my-2" />
                    <p>View latest post</p>
                    <p className="lead">
                        <Button color="primary" onClick={() => console.log("Implement me...")}>
                            What's a lahiyam?
                        </Button>
                    </p>
                </Jumbotron>
                <Nav className="border border-light">
                    <NavItem>
                ...
                <Row className="mt-0">
                    <Col className="mt-0">
                        <Post id="c9bc0deb-6ce4-4afc-a920-94e64139e254"
